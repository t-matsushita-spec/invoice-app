-- invoice-app: RLS 設定スクリプト（修正版）
-- 既存データを削除してから user_id を追加

-- ============================================================
-- Step 1: 既存データを削除（テスト環境なので問題なし）
-- ============================================================

-- invoice_items を先に削除（invoices への外部キーがあるため）
...
-- ============================================================
-- Step 2: invoices テーブルに user_id カラムを追加
-- ============================================================
...
-- ============================================================
-- Step 3: clients テーブルに user_id カラムを追加
-- ============================================================
...
-- ============================================================
-- Step 4: invoices テーブルの RLS を有効化・ポリシーを作成
-- ============================================================
...
-- ============================================================
-- Step 5: clients テーブルの RLS を有効化・ポリシーを作成
-- ============================================================
...
-- ============================================================
-- Step 6: settings テーブルの RLS を有効化
-- ============================================================
